...
/*
 * TI TAS2563 just mount one device to manage multiple devices,
 * so the kcontrols,widgets and route just keep one item.
 */
...
MODULE_DESCRIPTION("ASoC Intel SOF TI helpers");
MODULE_LICENSE("GPL");
